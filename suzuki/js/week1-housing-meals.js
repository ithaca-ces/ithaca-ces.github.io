...
function submitGoogleForm() {
    ...
    var formData = {
        ...
        'entry.55548226': $('input[id=inputID]').val()
    }
    // process the form
    $.ajax({
...
function webHook() {
    ...
    var text = "<b>WEEK 1 HOUSING & MEALS SUBMISSION</b><br>" + firstName + " " + lastName + " has submitted a Week 1 Housing & Meals Form:<br><ul>" + list + "</ul><i>(ID # " + id + ")</i>";
    $.ajax({
        data: JSON.stringify({
            "text": text
        }),
